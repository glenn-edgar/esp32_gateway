...
static char  link_state[18];
static unsigned link_data[18];
...
{ one_step_fn,(CF_FUN_AUX)setup_gpio_relay,(unsigned)0,(unsigned)0,(unsigned)0},
...
{
{ wait_event_count_fn,(CF_FUN_AUX)NULL,(unsigned)CF_SECOND_TICK,(unsigned)3,(unsigned)0},
...
{ 9,1,3,CHAIN_feed_watch_dog_LINKS},
{ 12,2,3,CHAIN_equipment_relay_monitor_LINKS},
{ 15,3,3,CHAIN_irrigation_relay_monitor_LINKS},
};
#endif
